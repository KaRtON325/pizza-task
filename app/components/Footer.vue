    ...
    <footer class="footer">
        <b-container>
            ...
            <b-row class="footer-text">
                <b-col>&copy; Pizza task  {{ new Date().getFullYear() }}</b-col>
            </b-row>
        </b-container>
    </footer>
</template>
